...
//        view.backgroundColor = .white
    ...
    lazy var selectionViewForTime: SelectionPopView = {
        let view = SelectionPopView() {
            ...
            //            self.fetchChartData(timeType: self.selectedTime)
        }
        return view
    }()
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        cv.dataSource = self
        cv.delegate = self
        cv.register(KLineTimeViewCell.self, forCellWithReuseIdentifier: KLineTimeViewCell.identifier)
    ...
    override func viewDidLoad() {
        ...
        fetchChartData(timeType: selectedTime)
    ...
    deinit {
        print("ChartCustomViewController deinit")
    }
...
extension ChartCustomViewController {
    ...
    //    // 拉取数据
    //    func fetchChartDatas(symbol: String, timeType: String, selectedTime: Int?) {
    ...
    // Get charts Data
    func fetchChartData(timeType: Int) {
        self.loadingView.startAnimating()
        self.loadingView.isHidden = false
        KlineViewModels.shared.historyForAppKline(symbol: userDidSelectedPair, timeType: self.times[self.selectedTime], size: 0) { [weak self] (flag, chartsData) in
...
extension ChartCustomViewController: CHKLineChartDelegate {
    ...
    func kLineChart(chart: CHKLineChartView, valueForPointAtIndex index: Int) -> CHChartItem {
        ...
        item.time = data.time/1000 // ktrade api 給毫秒 , 要除1000
...
extension ChartCustomViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return KLineTimeType.allCases.count
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: KLineTimeViewCell.identifier, for: indexPath) as! KLineTimeViewCell
        cell.configure(with: KLineTimeType.allCases[indexPath.item])
        return cell
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        self.selectedTime = indexPath.item
        fetchChartData(timeType: selectedTime)
    }
