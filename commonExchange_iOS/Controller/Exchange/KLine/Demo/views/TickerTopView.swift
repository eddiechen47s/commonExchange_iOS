...
//        labelPrice.isHidden = true
    ...
    func setupUI() {
        ...
        r1.addArrangedSubview(self.labelLow)
        r1.addArrangedSubview(self.labelClose)
        ...
        r2.addArrangedSubview(self.labelVol)
        r2.addArrangedSubview(self.labelTurnover)
...
//            make.top.bottom.equalToSuperview()
    ...
    func update(data: KlineChartData) {
        NotificationCenter.default.post(name: Notification.Name("closePrice"), object: "\(data.closePrice)")
        NotificationCenter.default.post(name: Notification.Name("labelRise"), object: "\(data.amplitudeRatio.toString(maxF: 2))%")
        NotificationCenter.default.post(name: Notification.Name("labelVol"), object: "\(data.vol.toString(maxF: 2))")
