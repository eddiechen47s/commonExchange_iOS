//
//  MostPoplurPairsViewController.swift
//  commonExchange_iOS
//
...
class MostPoplurPairsViewController: BaseMainTradingViewController {

    var viewModel = MostPoplurPairsViewModel()
    var disposeBag = DisposeBag()

    override func viewDidLoad() {
        super.viewDidLoad()

//        WsManager.shared.initTopFiveHeightSocket(url: WSURL.mostPoplurSearch.rawValue)
    }
